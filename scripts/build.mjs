...
const mobileNavTarget = '@media(max-width:430px){.section-nav{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:3px;flex-wrap:nowrap;width:100%}.section-nav a{display:flex;align-items:center;justify-content:center;padding:7px 2px;font-size:9px;min-height:36px;white-space:nowrap;width:100%}}';
