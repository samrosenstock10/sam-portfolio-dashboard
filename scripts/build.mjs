...
const mobileNavTarget = '@media(max-width:430px){.section-nav{gap:2px;flex-wrap:nowrap}.section-nav a{padding:8px 5px;font-size:10px;min-height:38px;white-space:nowrap}}';
